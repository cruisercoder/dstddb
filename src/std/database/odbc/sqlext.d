...
Adapted with minimal changes from andralex from the work of David L. Davis
(refer to the $(WEB
...
module std.database.odbc.sqlext;

private import std.database.odbc.sql;
private import std.database.odbc.sqltypes;
